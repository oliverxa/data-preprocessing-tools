...
def write_anchors_to_file(centroids, distance, anchor_file):
    anchors = centroids * 416 / 32      # image size is  416 and stride is 32
...
if "__main__" == __name__:
    ...
    parser.add_argument('--num_clusters', '-n', default=6, type=int, help='Number of Clusters')
    parser.add_argument('--output', '-o', default='./anchor.txt', type=str, help='Result Output File')
